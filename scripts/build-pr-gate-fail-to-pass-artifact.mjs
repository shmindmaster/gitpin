...
function buildFixture(workspaceRoot) {
  ...
  const artifact = {
    ...
    links: {
      ...
      github_release: 'https://github.com/shmindmaster/gitpin/releases/tag/v0.6.3',
      github_action: 'https://github.com/shmindmaster/gitpin/actions/workflows/evidence-gate.yml',
      github_action_snippet: 'uses: shmindmaster/gitpin@v0.6.3',
      mcp_registry:
...
Deterministic, synthetic, fail-to-pass artifact for the GitPin v0.6.3 PR evidence gate.
...
function generateSvg(artifact) {
  ...
  const titleLines = emitTextLines(
    'GitPin 0.6.3: synthetic fail-to-pass PR evidence gate artifact',
    36,
    48,
    'title',
    36,
