...
| --- | --- | --- |
| `npx` fails on Node | Node older than 20 | Install Node 20+ and retry `npx -y gitpin@0.6.4 init --client codex` |
...
1. Run `npx -y gitpin@0.6.4 doctor` with `GITPIN_REGISTRY` set.
