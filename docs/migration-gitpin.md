# Migration: RepoContext to GitPin (0.5.2)
...
| Item | 0.3.x RepoContext | 0.5.2 GitPin |
| --- | --- | --- |
...
1. Publish `gitpin@0.5.2` via the tag workflow to verify npm trusted publishing end to end.
